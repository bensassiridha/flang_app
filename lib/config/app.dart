...
class Config {
  ...
  /// Generated by SiteNative 16-08-2022 13:23:17
  /// App UID: 1f48881a-f85d-3c5d-36a9-40fd45819905
  /// Version: https://apps.mbh-fiduciaire.site/backend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "RLC SUISS CAR";
  // App link
  static String appLink = "https://rlcswisscars.ch/";
  ...
  // Signing
  static String osSigning = "41a909c009344e38e175ac5ca5ed8d6bb3c9679a8430cd3441c49dbb21a0a0fc";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "Accueil",icon: "albums-outline.svg",type: ActionType.internal,value: "http://rlcswisscars.ch/",),
	NavigationItem(name: "A propos",icon: "albums-outline.svg",type: ActionType.internal,value: "https://rlcswisscars.ch/a-propos",),
