...
class Config {
  ...
  /// Generated by SiteNative 24-07-2022 03:56:56
  /// App UID: a65e5e63-0e8e-84cf-fc19-8269256a1f84
  /// Version: https://apps.mbh-fiduciaire.site/backend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "KL automobile";
  // App link
  static String appLink = "https://kl-automobiles.ch/";
  ...
  // Signing
  static String osSigning = "a38e3431f79641113c8b57fc3e2a03a1f31c8e0b11767089b38e06bbdc14f80c";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "nav",icon: "albums-outline.svg",type: ActionType.internal,value: "https://kl-automobiles.ch/",),
